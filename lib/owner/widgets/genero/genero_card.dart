...
class GeneroCard extends StatelessWidget {
  ...
  GeneroCard({Key key,this.id, this.nombre, this.descripcion, this.fecha});
            ...
            children: <Widget>[
              Container(
                ...
                child: ButtonOption(
                  ...
                  icon: Icons.delete,
                  onPressed: (){
                    genreController.removeGenre(id);
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (BuildContext context) => Warning(text: "Genero eliminado",)));
                  },
                ),
              ),
              Container(
                ...
                child: ButtonOption(
                  ...
                  onPressed: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (BuildContext context) => GeneroEdit(id, nombre, descripcion,)));
                  },
                ),
              )
            ],
