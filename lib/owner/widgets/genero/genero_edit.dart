...
class GeneroEdit extends StatefulWidget{
  final String id;
  final String nombre;
  ...
  GeneroEdit(this.id, this.nombre, this.descripcion,);
...
class _GeneroEdit extends State<GeneroEdit>{
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Button(
                        ...
                        onPressed: () {
                          if(complete()==true) {
                            genreController.editGenre(widget.id, _controllerNombre.text, _controllerDescripcion.text,);
                            Navigator.push(
                                context,
                                MaterialPageRoute(
